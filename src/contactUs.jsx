  ...
  return (
    <div className="relative w-full min-h-screen bg-white font-montserrat">
      ...
      <div className="relative w-full h-[607px] overflow-hidden">
        ...
        {/* Contact Us Title */}
        <div className="absolute top-0 left-1/2 transform -translate-x-1/2 w-full pt-8">
          <h1 className="text-center text-white text-4xl md:text-5xl font-normal uppercase tracking-wide">
            Contact Us
          </h1>
        </div>
        ...
        <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 w-full max-w-[1280px] px-4 pb-8">
          <div className="flex flex-wrap justify-center gap-3.5">
            {/* Email Card */}
            <div className="bg-white rounded-lg p-4 w-[260px] h-[200px] flex flex-col items-center justify-between" style={{
              boxShadow: '0px 4px 9px 0px rgba(0,0,0,0.1), 1px 17px 17px 0px rgba(0,0,0,0.09), 3px 38px 23px 0px rgba(0,0,0,0.05), 5px 67px 27px 0px rgba(0,0,0,0.01), 8px 104px 29px 0px rgba(0,0,0,0)'
            }}>
              <div className="w-[126px] h-[63px] flex items-center justify-center mb-6">
                <div className="w-full h-full bg-[#3d3021] rounded-full flex items-center justify-center">
                  <img src={mailRounded} alt="Email" className="w-8 h-8" />
                </div>
              </div>
              <div className="text-center">
                <h3 className="font-semibold text-lg text-black mb-4 capitalize">Email</h3>
                <p className="font-normal text-sm text-black">cozycandlecorner13@gmail.com</p>
              </div>
            </div>

            {/* Phone Card */}
            <div className="bg-white rounded-lg px-16 py-4 w-[260px] h-[200px] flex flex-col items-center justify-between" style={{
              boxShadow: '0px 4px 9px 0px rgba(0,0,0,0.1), 1px 17px 17px 0px rgba(0,0,0,0.09), 3px 38px 23px 0px rgba(0,0,0,0.05), 5px 67px 27px 0px rgba(0,0,0,0.01), 8px 104px 29px 0px rgba(0,0,0,0)'
            }}>
              <div className="w-[126px] h-[63px] flex items-center justify-center mb-6">
                <div className="w-full h-full bg-[#3d3021] rounded-full flex items-center justify-center">
                  <img src={call} alt="Phone" className="w-8 h-8" />
                </div>
              </div>
              <div className="text-center">
                <h3 className="font-semibold text-lg text-black mb-4 capitalize">Phone</h3>
                <p className="font-normal text-sm text-black">+91 8019401322</p>
              </div>
            </div>

            {/* Address Card */}
            <div className="bg-white rounded-lg px-8 py-4 w-[260px] h-[200px] flex flex-col items-center justify-between" style={{
              boxShadow: '0px 4px 9px 0px rgba(0,0,0,0.1), 1px 17px 17px 0px rgba(0,0,0,0.09), 3px 38px 23px 0px rgba(0,0,0,0.05), 5px 67px 27px 0px rgba(0,0,0,0.01), 8px 104px 29px 0px rgba(0,0,0,0)'
            }}>
              <div className="w-[126px] h-[63px] flex items-center justify-center mb-6">
                <div className="w-full h-full bg-[#3d3021] rounded-full flex items-center justify-center">
              ...
              <div className="text-center">
                <h3 className="font-semibold text-lg text-black mb-4 capitalize">Address</h3>
                <p className="font-normal text-sm text-black">Hyderabad, Gajularamaram</p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg px-8 py-4 w-[260px] h-[200px] flex flex-col items-center justify-between" style={{
              ...
              <div className="relative w-[126px] h-[63px] flex items-center justify-center mb-6">
                <div className="absolute inset-0 bg-[#3d3021] rounded-full"></div>
              ...
              <div className="text-center">
                <h3 className="font-semibold text-lg text-black mb-4 capitalize">Instagram</h3>
                <p className="font-normal text-sm text-black">@cozycreationscandle</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white border-2 border-[#3d3021] rounded-[32px] w-full max-w-[1080px] p-8 md:p-12">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="pt-4">
              <button
                type="submit"
                className="w-full h-[62px] bg-yellow-accent rounded-xl text-2xl font-bold text-black capitalize hover:bg-yellow-500 transition-colors"
              >
                Place Order
              </button>
            </div>
